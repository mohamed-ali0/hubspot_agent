"""
Working Sales Flow Test Script
Tests the sales process with correct HubSpot API formats
"""
...
class WorkingSalesFlowTester:
    ...
    def step2_create_company(self):
        """Step 2: Create a company with valid industry"""
    ...
    def step3_create_deal(self):
        """Step 3: Create a deal with correct associations format"""
        self.print_header("STEP 3: CREATE DEAL")
        ...
        try:
            deal_data = {
                ...
                "associations": [
                    {
                        "to": {"id": self.test_data.get('contact_id', '')},
    ...
    def step4_create_note(self):
        """Step 4: Create a note with correct associations format"""
        self.print_header("STEP 4: CREATE NOTE")
        ...
        try:
            note_data = {
                ...
                "associations": [
                    ...
                    {
                        "to": {"id": self.test_data.get('deal_id', '')},
    ...
    def step5_create_task(self):
        """Step 5: Create a task with correct associations format"""
        self.print_header("STEP 5: CREATE TASK")
    ...
    def run_working_flow(self):
        """Run the working sales flow test"""
        print("HubSpot Logging AI Agent - Working Sales Flow Test")
        print("=" * 70)
        print("This test will follow a working sales process:")
        ...
        self.step3_create_deal()
        self.step4_create_note()
        self.step5_create_task()
        ...
        if failed > 0:
            ...
            print("\n[SUCCESS] Working sales flow test completed!")
...
if __name__ == "__main__":
    tester = WorkingSalesFlowTester()
    tester.run_working_flow()
