"""
Simplified Sales Flow Test Script
Tests the core sales process with existing HubSpot setup
"""
...
class SimplifiedSalesFlowTester:
    def __init__(self):
    ...
    def step1_create_contact(self):
        """Step 1: Create a contact (simplified lead)"""
    ...
    def step3_create_deal(self):
        ...
        try:
            deal_data = {
                ...
                "associations": {
                    "contacts": [self.test_data.get('contact_id', '')],
                    "companies": [self.test_data.get('company_id', '')]
                }
            }
    ...
    def step4_create_note(self):
        ...
        try:
            note_data = {
                ...
                "associations": {
                    "contacts": [self.test_data.get('contact_id', '')],
                    "deals": [self.test_data.get('deal_id', '')]
                }
            }
    ...
    def run_simplified_flow(self):
        """Run the simplified sales flow test"""
        print("HubSpot Logging AI Agent - Simplified Sales Flow Test")
        print("=" * 70)
        print("This test will follow a simplified sales process:")
        ...
        if failed > 0:
            ...
            print("\n[SUCCESS] Simplified sales flow test completed!")
...
if __name__ == "__main__":
    tester = SimplifiedSalesFlowTester()
    tester.run_simplified_flow()
